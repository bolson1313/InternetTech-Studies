...
<body>
  ...
  <div id="wycieczki" class="container mb-5">
    ...
    <div class="row">
      <?php foreach ($trips as $card) : ?>
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="card">
            <img src=<?php print "\"img/" . $card->getImg() . "\"";  ?> class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title"><?php print $card->getName() ?></h5>
              <p class="card-text"><?php print $card->getDescription(); ?></p>
  ...
  <div id="cennik" class="container mt-5 mb-5">
    ...
    <table class="table table-hover table-striped">
      ...
      <tbody>
        <?php foreach ($trips as $strip) : ?>
          <tr>
            <th scope="row"><?php print $strip->getId(); ?></th>
            <td><?php print $strip->getName(); ?></td>
            <td><?php print $strip->getContinent(); ?></td>
            <td><?php print $strip->getCountry(); ?></td>
            <td><?php print $strip->getPeriod(); ?> dni</td>
            <td><?php print $strip->getPrice(); ?></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
