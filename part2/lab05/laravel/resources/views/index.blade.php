      ...
      <div id="carouselExampleCaptions" class="carousel slide">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{ asset('img/carousel1.jpg') }}" class="d-block w-100" alt="carousel1">
            <div class="carousel-caption d-none d-md-block">
              <h1 class="text-white">Niesamowite przeżycia!</h1>
            </div>    
          </div>
          <div class="carousel-item">
            <img src="{{ asset('img/carousel2.jpg') }}" class="d-block w-100" alt="carousel2">
            <div class="carousel-caption d-none d-md-block">
    ...
    <div id="wycieczki" class="container mt-5">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="card">
            <img src="{{ asset('storage/img/colorado.jpg') }}" class="card-img-top" alt="colorado">
            <div class="card-body">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="card">
              <img src="{{ asset('storage/img/alaska.jpg') }}" class="card-img-top" alt="alaska">
              <div class="card-body">
      ...
      <div class="col-12 col-sm-6 col-lg-3">
          <div class="card">
              <img src="{{ asset('storage/img/everest.jpg') }}" class="card-img-top" alt="everest">
              <div class="card-body">
      ...
      <div class="col-12 col-sm-6 col-lg-3">
          <div class="card">
              <img src="{{ asset('storage/img/alps.jpg') }}" class="card-img-top" alt="alpy ">
              <div class="card-body">
